...
void RunAction::BeginOfRunAction(const G4Run*)
{
    ...
    // Open an output file
    analysisManager->OpenFile("SpectreGE");
    // Create histograms
    analysisManager->CreateH1("Edep", "Energy deposit", 2000, 0. * keV, 1500* keV);
    //alysisManager->CreateH1("Tlen", "Track length", 100, 0., 100 * mm)
}
